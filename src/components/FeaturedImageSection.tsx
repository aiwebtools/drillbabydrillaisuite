...
const FeaturedImageSection: React.FC = () => {
  return <section className="py-8 px-4 bg-energy-950 relative overflow-hidden">
      <div className="container mx-auto max-w-5xl" data-animate="true">
        ...
        <div className="rounded-xl overflow-hidden shadow-lg shadow-drill-600/20 mx-auto">
          <img src="https://ideogram.ai/assets/image/lossless/response/lmQ_XQgaTge4ZGsQnt1UWg" alt="Oil and gas industry visualization" className="w-full h-auto" />
        </div>
      </div>
